  ...
  render() {
    return (
      <div className="boxcontainer" id="box">
        <Typography className="supplier_signup" variant="h5">
          <b>Supplier Login</b>
        </Typography>
        ...
        <Stack>
          ...
          {this.state.erroremail ? (
            <p className="p">{this.state.erroremail}</p>
          ) : (
            <p className="pr">.</p>
          )}
        </Stack>
        <Stack>
          ...
          {this.state.errorPassword ? (
            <p className="p">{this.state.errorPassword}</p>
          ) : (
            <p className="pr">.</p>
          )}
        </Stack>
        ...
        <div
          className="line"
          style={{
            border: "0.1px solid rgba(49, 49, 49, 0.5)",
            position: "relative",
            marginTop: "30px",
          }}
        >
        ...
        <div className="boxcontainer state-text" onClick={this.props.toggle}>
          <p style={{ color: "gray", fontSize: "12px", margin: "0px" }}>
            You do not have an account?{" "}
            <span style={{ color: "#3388EB", textDecoration: "underline" }}>
              Join Now
            </span>
          </p>
        </div>
